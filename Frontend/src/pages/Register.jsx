  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_100%_100%,rgba(255,184,0,0.12),transparent_60%)]" />
        <div
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-surface/80 backdrop-blur-xl border border-border p-8 rounded-2xl shadow-2xl shadow-black/60">
          ...
          <p className="text-textSecond text-sm mb-6">Track, rate and pick what to watch next.</p>
          ...
          <div className="space-y-3" onKeyDown={handleKeyDown}>
            ...
            <button
              onClick={submit}
              disabled={loading}
              className="w-full bg-secondary hover:bg-secondaryHover disabled:opacity-60 disabled:cursor-not-allowed text-black font-bold py-3 rounded-xl transition-colors mt-2"
            >
          ...
          <p className="text-textSecond text-sm mt-6 text-center">
            ...
            <Link to="/login" className="text-accent hover:text-accentHover font-medium">Login</Link>
          </p>
        </div>
      </div>
    </div>
